...
note to start the program just run the interface.py file. finle note, i putted a example for finle report in the server folder so you don't have to run the model :) 
